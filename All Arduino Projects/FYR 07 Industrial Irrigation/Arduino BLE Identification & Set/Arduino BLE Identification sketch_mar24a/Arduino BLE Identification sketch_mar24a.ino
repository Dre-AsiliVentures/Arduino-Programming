...
// Copyright, Arik Yavilevich from https://github.com/ayavilevich/arduino-ble-ident-n-set/blob/master/arduino-ble-ident-n-set.ino
// Code deployed by Andrew Mwendwa (GreHiDeL) on 24th Mar 2022
// Test results : Not successful after testing TX from Module = OV
