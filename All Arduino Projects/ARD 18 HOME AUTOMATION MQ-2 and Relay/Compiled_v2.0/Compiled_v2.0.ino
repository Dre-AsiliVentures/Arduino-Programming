...
const int rs = 12, en = 11, d4 = 13, d5 = 0, d6 = 1, d7 = 2;
...
float current_gas_stateValue=analogRead(mq2_gas_sensor);
...
if (current_gas_stateValue>=300)
{
  ...
  Serial.println("");
  Serial.print("AQ: ");
  Serial.print(current_gas_stateValue);
